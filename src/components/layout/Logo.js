export default function Logo({ size = 26, className = '', showBackground = true }) {
    return (
        <svg width={size} height={size} viewBox='0 0 32 32' fill='none' xmlns='http://www.w3.org/2000/svg' className={className} aria-hidden='true'>
            {showBackground && (<rect x='1' y='1' width='30' height='30' rx='7' stroke='currentColor' strokeOpacity='0.35' strokeWidth='1.5' />)}
