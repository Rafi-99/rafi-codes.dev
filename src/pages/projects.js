        ...
        <>
            ...
            <div className = {styles.cards_container}>
                <div>
                    ...
                    <h1>The Monitor ™&nbsp;<Link href="https://www.github.com/Rafi-99/The-Monitor"><a rel="noopener noreferrer" target="_blank" aria-label="Link to Rafi's GitHub Project | The Monitor ™"><SiGithub /></a></Link></h1>
                ...
                <div>
                    ...
                    <h1>Meme API&nbsp;<Link href="https://www.github.com/Rafi-99/Meme-API"><a rel="noopener noreferrer" target="_blank" aria-label="Link to Rafi's GitHub Project | Meme API"><SiGithub /></a></Link></h1>
